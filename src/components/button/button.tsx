...
interface SwdButtonProps {
    ...
    isFocused?: boolean; // Determines if button will use focused styles (true) or not (false).
    showForwardIcon?: boolean; // Determines if button will show (true) right icon or not (false).
...
const Button: React.FC<SwdButtonProps> = (
    ...
    const classList = [primaryClass, activeClass, focusClass];
